...
val ButtonBlue = Color(0,76,255)
val ButtonBlack = Color(32,32,32)
val NotifyBlock = Color(249,249,249)
val Selected = Color(229,235,252)
val TextColor = Color.Black
val IconBlue = Color(0,76,255)
val NavIconColor = Color(0,76,255)
val NavIconSelected = Color.Black
val ButtonGray = Color(231,232,235)
